...
export const ROLES: Role[] = [
  ...
  },
  {
    ...
    kind: 'pulse',
    summary: 'Delivery and security tooling, across three clouds.',
    bullets: [
      ...
      'Designed a global service collecting and rendering OSS library metrics and vulnerabilities, for centralised security insight across deployments',
      'Extended ZAP security scanning to cover API testing against OpenAPI v2 and v3',
      'Integrated a security toolchain including ScoutSuite (CSPM) and network reachability',
